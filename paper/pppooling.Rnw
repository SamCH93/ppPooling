...
amounts of data \citep[section 6.6]{Held2020d}. Since the power prior is a prior
...
distribution and the data have normal or binomial likelihood. Instead, there is
a limiting posterior distribution that is hardly different from the prior, which
implies that a complete pooling is impossible.
